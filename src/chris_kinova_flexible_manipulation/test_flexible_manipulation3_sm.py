	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('GetJVList',
										GetCurrentJointValuesListState(joint_names=['m1n6s200_joint_1', 'm1n6s200_joint_2', 'm1n6s200_joint_3', 'm1n6s200_joint_4'], timeout=None, joint_states_topic='/m1n6s200/joint_states'),
			...
			OperatableStateMachine.add('GetJVUser',
										GetCurrentJointValuesUserState(timeout=5.0, joint_states_topic='/m1n6s200/joint_states'),
